                        ...
                        @elseif ($language == 'DE')
                            ...
                            Wir haben Ihnen bereits Links mit Anweisungen geschickt, um Ihr Gerät wieder zum Zählen zu bringen. Falls Sie diese benötigen, finden Sie sie hier:
                             <ul>
                                ...
                                <br>
                                <br>
                                Wenn dies Ihr Problem nicht gelöst hat, würden wir gerne von Ihnen hören. Schreiben Sie uns bitte an <a href="mailto:support@telraam.net">support@telraam.net</a> und wir werden so viel Rat wie möglich geben.<br>
                                <br>
                                ...
                                Uns liegt Ihre Privatsphäre am Herzen sowie die Integrität der Verkehrsprojekte, an denen wir gemeinsam arbeiten.<br>
                                <br>
                                <h4>Vielen Dank!</h4>
                        ...
                        @elseif ($language == 'ES')
                            ...
                            Anteriormente le enviamos enlaces con instrucciones para que su dispositivo vuelva a contar. En caso de que los necesite, puede encontrarlos aquí:
                             <ul>
                                ...
                                Nos preocupamos por su privacidad y también por la integridad de los proyectos de tráfico en los que trabajamos juntos.<br>
                                <br>
                                <h4>¡Gracias!</h4>
