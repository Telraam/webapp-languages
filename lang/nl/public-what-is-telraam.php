...
de burgers die leven door - en gebruiken - deze straten, door verkeer te omzetten in een open en toegankelijk Citizen Science-project.<br><br>',
    ...
    // questions
    'section2-intro-question'  => 'Sluipverkeer. Verkeersstromen rond scholen. Verkeersveiligheid. Luchtvervuiling. Actief reizen. Complexe kwesties vereisen kwantitatieve verkeersgegevens. Hoe raken we makkelijk aan verkeersdata?',
    'section2-intro-answer'  => 'Telraam is uw citizen science oplossing. Wij bieden een gebruiksvriendelijke web-based tool, best practices voor werving en een bekroonde api.',
    ...
    <br>
   Het verzamelen van gegevens om een volledig beeld te krijgen van vervoer, vrije tijd en sociale activiteit voor een netwerk van straten is vaak onmogelijk of zeer duur met traditionele
...
Het betrekken van burgers en het publiceren van open data brengt onderzoekers en beleidsmakers in contact met de plaatselijke bewoners, waardoor mogelijkheden ontstaan voor interactie, dialoog, co-creatie en andere vormen van participatie..',
    ...
    // testimonials
    'quote1' => 'Door analyse van de V85 norm krijgen we een indicatie, op welk tijdstip, het dispositief voor
...
Deze werkwijze en de open toegang tot de verzamelde verkeersgegevens, democratiseert het proces van lokale verkeersplanning en opent nieuwe mogelijkheden voor alle betrokken partijen.</p>',
    ...
    <p>Burgerwetenschapsprojecten kunnen voor lokale overheden een kostenbesparende manier zijn om gegevens te verzamelen en inzicht te krijgen in verkeersproblemen in hun gemeenschap. Er zijn geen dure interventies nodig om de veiligheid van de straatgebruikers en de telapparaten te beschermen.</p>',

    'cit-science-item-2' => '<strong  class="green">Lokale kennis</strong><br>
    <p>Burgerwetenschappers kennen hun eigen buurt het best. Ze beschikken over heel wat lokale kennis en perspectieven die waardevol kunnen zijn bij het begrijpen van lokale problemen en het ontwikkelen van oplossingen.</p>',
