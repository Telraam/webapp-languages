...
return [
    ...
    'subtitle'          => 'Een verhaal over verkeerskunde en burgerwetenschap die met elkaar trouwen',

    'section-1-title'            => 'Ontstaan',
    'section1-block1-text'        => '<p>Telraam is het geesteskind van twee organisaties uit Leuven (BE):
...
2023 <a href="https://telraam.net/en/S2">een speciaal ontworpen sensor</a> te ontwikkelen voor het verzamelen van verkeersdata, in samenwerking met burgers.</p>',
    ...
    'section2-block1-text'        => '<p> Onze missie bij Telraam is om een almaar groeiend internationaal platform te zijn, dat burgers in staat stelt en opleidt tot de toekomstige verkeersingenieurs en data-technici van hun buurt. Deze burger-experts brengen hun lokale kennis ter tafel, en worden een drijvende kracht in gesprekken en debatten over stedelijk mobiliteitsbeleid binnen hun buurt. </p>

<p>Onze ambitie is om betaalbare oplossingen aan te bieden die burgers en hun lokale overheden met elkaar in contact te brengen, en op die manier een verschuiving naar een meer mensgerichte en multimodale verkeerscultuur te faciliteren. </p>',

'section2-block2-text'        => '<p>Omdat we een verkeerskundige achtergrond hebben, kennen we verkeerstellingen. We ademen zelfs verkeerstellingen. Wij begrijpen welk type data waardevol kan zijn voor professionals. Ben je een mobiliteitsprofessional, een non-profit organisatie, een verkeerskundig ingenieurs- of adviesbureau, een vervoersbureau of een lokale overheid?<br>
 <br>
Bent u op zoek naar een betaalbare, multimodale oplossing voor de verkeersmonitoring van uw project die op een groot aantal locaties kan worden ingezet? Dan bent u bij Telraam aan het juiste adres!</p>',

    // press
    'press-title' => 'In de pers',
