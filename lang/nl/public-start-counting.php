...
return [
    ...
    'sub-title' => 'Met Telraam kunt u het verkeer in uw straat tellen met een klein, autonoom apparaatje, gewoon door gebruik te maken van het uitzicht uit uw raam.',
...
<p>Verkeerstellingen op zich zijn geen oplossing, maar in bekwame handen kan het een krachtig, kwantitatief instrument zijn dat een solide basis vormt voor zinvolle veranderingen, ten voordele van de leefbaarheid.</p>',
    ...
    'section1-text-part-2' => '<p>Steeds meer lokale besturen vinden manieren om deze verkeers- en mobiliteitskwesties aan te pakken, om onze woonwijken veiliger en gezonder te maken, maar daarvoor hebben ze cijfermateriaal nodig.</p>

<ul class="jump-in">
<li>Data over hoeveel verkeer er vandaag is.</li>
<li>Data over wat er moet veranderen.</li>
<li>Data over hoe de veranderingen verlopen.</li>
</ul>
...
<tr>
    ...
    'all-networks-text' => 'Blader hier door een volledig overzicht van vroegere en huidige netwerken',
    'all-networks-more' => 'Meer',
