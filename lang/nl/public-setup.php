...
return [
    ...
    'description' => 'Profociat, je bent een Telraam S2 host. In de volgende stappen leggen we uit hoe je het toestel installeert',

   'current-installation-title' => 'Huidige installatie van dit toestel',
    'is-counting' => 'Is aan het tellen',
    'counted-before' => 'Heeft geteld',
    'no-counting-yet' => 'Nog geen telling gedaan',
    ...
    'ready-to-install' => 'Ben je klaar om het Telraam op je locatie te installeren?',
