...
// FAQ content not ready yet for S3 — kept as a straight copy of telraamV2-FAQ.php (S2 wording and all)
// as a placeholder until real S3 FAQ content is provided.
...
return [
	...
	'answer-1'           => 'Nee, vanwege de technologische verbetering die het Telraam S2 toestel biedt ten opzichte van de Telraam V1 sensor, kunnen we geen inruilkorting bieden voor de aankoop van een nieuwe Telraam S2 sensor voor bestaande Telraam V1 eigenaren. Aan de andere kant, als u een Telraam V1 hebt, kunt u altijd de onderdelen (Raspberry Pi 3A+ computer en Raspberry Pi cameramodule) van uw toestel verkopen op de hobby-elektronicamarkt om uw nieuwe Telraam S2 te sponsoren. Of u kunt uw gemeente overtuigen om een nieuw, gefinancierd Telraam-project op te zetten en op die manier mogelijk een nieuw Telraam S2-toestel gratis te krijgen. In de tussentijd blijven alle Telraam V1-toestellen werken en zult u ook in de toekomst gegevens van uw Telraam V1-toestel op het Telraam-netwerk kunnen zien. Er komen echter geen feature-upgrades meer voor de Telraam V1 toestellen.',
 	'question-2'           => 'Welke soort data wordt doorgestuurd vanop een Telraam S2 toestel?',
 	'answer-2' 			=> 'Privacy is altijd een topprioriteit voor ons bij Telraam. AI-gebaseerde beeldherkenning en het tracken van objecten gebeurt enkel op het toestel, en alleen de hieruit resulterende geaggregeerde tel-(en snelheids-)gegevens worden doorgestuurd naar de Telraam-server. Aangezien de gegevens worden geaggregeerd, worden individuele objectkenmerken niet verzonden.',
 	 	'question-3'           => 'Welk soort netwerkverbinding is vereist voor de S2 om gegevens te kunnen doorsturen?',
 	'answer-3' 			=> 'Onze Telraam S2-toestellen worden geleverd met een ingebouwde SIM-kaart die een energiezuinige mobiele dataverbinding biedt via de LTE-M- of NB-IoT-frequentieband van de lokale mobiele netwerkprovider(s). Hoewel deze technologieën al bijna overal ter wereld beschikbaar zijn, kunt u voordat u een Telraam S2-toestel koopt de <a href="https://www.u-blox.com/en/iot-network-coverage"  target="_blank">netwerkdekkingskaart</a> raadplegen om er zeker van te zijn dat uw toestel gegevens kan verzenden.
Telraam S2 heeft geen wifi-verbinding nodig, en er is geen mogelijkheid om wifi te gebruiken in plaats van de meegeleverde mobiele dataverbinding.',
 	 	'question-4'           => 'Welke types weggebruikers kan het Telraam S2 identificeren?',
 	'answer-4' 			=> 'De nieuwe AI-chip in de Telraam S2 kan onderscheid maken tussen tien soorten weggebruikers: voetgangers, kinderwagens, fietsen, motorfietsen, auto\'s, lichte vrachtwagens, aanhangwagens, vrachtwagens en bussen. Voorlopig worden de verkeersgegevens afkomstig van Telraam S2-toestellen op dezelfde manier gevisualiseerd als dit voor de gegevens van de Telraam V1-toestellen gebeurde. Namelijk, de tellingen worden geaggregeerd in vier categorieën: voetgangers, tweewielers, auto\'s en grote voertuigen. Ondertussen worden voor de Telraam S2-toestellen wel al gegevens opgeslagen voor elk van deze tien vervoersmodi, en de webinterface en de verkeers-API zullen in de nabije toekomst worden bijgewerkt om alle nieuwe modi op te nemen.',
 	 	'question-5'           => 'Wat is de nauwkeurigheid en precisie van het Telraam S2?',
 	'answer-5' 			=> 'De nauwkeurigheid en precisie van Telraam S2 wordt voortdurend gevalideerd en gedocumenteerd. Deze artikels hebben betrekking op de <a href="https://github.com/Telraam/Telraam-S2/blob/main/count-performance-validation.md"  target="_blank">nauwkeurigheid van de tellingen</a> en <a href="https://github.com/Telraam/Telraam-S2/blob/main/count-consistency-validation.md"  target="_blank">precisie van de tellingen</a> en <a href="https://faq-nl.telraam.net/article/102/snelheidsmetingen-met-telraam-s2"  target="_blank">de snelheidsmetingen</a>. In het algemeen is de huidige nauwkeurigheid overdag 90-95% voor een groot aantal testlocaties, waarbij alleen voetgangers in bepaalde specifieke omstandigheden beduidend slechter presteren. Precisie is geen beperkende factor, aangezien de spreiding tussen toestellen gering is. Voor optimale prestaties moet u ervoor zorgen dat uw Telraam S2 op een geschikte locatie is geïnstalleerd (zie: Waar kan ik een Telraam S2 installeren) en tijdens de registratieprocedure een <a href="https://faq-nl.telraam.net/article/104/interessegebied-roi-en-roi-selectie-met-telraam-s2"  target="_blank">correct interessegebied (ROI)</a> specifiek voor uw Telraam in te stellen.',
 	 	'question-7'           => 'Waar kan ik een Telraam S2 installeren? ',
 	'answer-7' 			=> 'Telraam S2-toestellen moeten worden geïnstalleerd
<ul class="jump-in">
<li>aan een raam dat een vrij en onbelemmerd zicht biedt op de gehele breedte van de straat beneden (geen bomen, geen brede palen of leuningen in het gezichtsveld)</li>
<li>langs een weg die parallel aan het raam loopt, zonder kruispunten (hoeken, bochten) in het zicht</li>
<li>niet op de begane grond, zodat het toestel het verkeer onder een enigszins neerwaartse hoek kan zien (de eerste verdieping zal in de meeste gevallen optimaal zijn, terwijl hogere verdiepingen kunnen werken voor zeer brede wegen met meerdere rijstroken, zodat het verkeer onder een hoek van 30-45 graden wordt gezien).</li>
</ul>
<br>
Enkele voorbeelden van goede en slechte locaties staan in ons FAQ-artikel: <a href="https://faq-nl.telraam.net/article/75/vereisten-voor-de-plaatsing-van-mijn-telraam-foto-op-het-deelnameformulier"  target="_blank">Vereisten voor de plaatsing van mijn Telraam</a>',
