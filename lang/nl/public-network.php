...
<ul class="text-list">
    ...
    <br>Je kunt beslissen of en wanneer je de inhoud openbaar maakt, of dat je deze beperkt tot een selecte groep. Je kunt ook meerdere \'tracks\' maken om je dataverzameling te segmenteren naar tijd of locatie.<br>
    <br>Lever support, verbeter de gegevensverzameling en diagnosticeer en verhelp problemen via sensorbeheer van op afstand. Je kan ook steeds voor deskundige hulp bij het Telraam-team terecht.</p>',

    'features-3-title' => 'Rekrutering en gebruikersbeheer',
    'features-3-text' => '<p>Deelname van burgers is onontbeerlijk in een Telraam netwerk. Binnen het Telraam dashboard, houdt men tijdslijn van je netwerk bij, rekruteert en selecteert men gebruikers, beheert men aanvragen en interageert men met geïnteresseerden tijdens het project dankzij de ingebouwde communicatietools.<br>',

    'features-3-recruit-title' => 'Kandidaten werven:',
    'features-3-recruit-list' => '
    <ul class="text-list small">
    <li>Bepaal welke gegevens van kandidaat-burgers worden verzameld via het kandidatenformulier.</li>
    <li>Beoordeel kandidaten op basis van hun locatie op de kaart, en de kwaliteit van hun zicht op de rijbaan op basis van hun foto\'s. Werk hiervoor samen met andere beheerders door notities en beoordelingen toe te voegen.</li>
    <li>Aanmeldingen rangschikken voor een toekomstige beoordeling, selecteren of op een wachtlijst plaatsen.</li>
    <li>Personaliseer alle mailcorrespondentie voor geautomatiseerde of ad-hoc communicatie.</li>
    </ul>',

    'features-3-interact-title' => 'Interageren met de gebruikers:',
 'features-3-interact-list' => '<ul class="text-list small">
    ...
    <li>Exportopties zijn onder andere maandrapporten, maandelijkse of volledige onbewerkte gegevenssets en typisch verkeer (voor twee door de gebruiker gedefinieerde periodes).</li>
...
ruwe gegevens te verwerken of via de API\'s te hoeven werken.</li></ul>',
    ...
    'extra-features-2' => 'Beheer netwerk branding & content',
    'extra-features-3' => 'Werving van kandidaten & selectie',
    'extra-features-4' => 'Geautomatiseerd mails & templates',

    'extra-features-5' => 'Basis analyse tools voor overzicht',
    'extra-features-6' => 'Geavanceerde tools voor data-analyse',
    'extra-features-7' => 'Sensorbeheer',
    'extra-features-8' => 'Meerdere parallele tracks',

    'extra-features-9' => 'Geavanceerde API-toegang',
    'extra-features-10' => 'Peer-to-peer ondersteuning',
    'extra-features-11' => 'Prioritaire ondersteuning via mail',
    'extra-features-12' => 'Trainingssessies',
