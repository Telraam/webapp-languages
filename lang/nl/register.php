...
return [
    ...
    'title' => 'Registreren voor een Telraam-account',
 ...
 <a href="https://telraam.zendesk.com/hc/nl/articles/360019257837-Vereisten-voor-de-plaatsing-van-mijn-Telraam-Foto-op-het-deelnameformulier" target="_blank">de ideale plaatsingsvereisten</a>',
...
<li>Je beschikt over een stopcontact in de buurt van het raam (dit kan uiteraard met verlengkabel).</li>',
    ...
    'select-country' => 'Gelieve je land te selecteren',
    'select-network' => 'Gelieve je network/zone te selecteren',

    'country-required-error' => 'Je land is verplicht',
    'network-required-error' => 'Je network/zone is verplicht',

    'select-language' => 'Voorkeurstaal',
    'english' => 'Engels',
    'dutch' => 'Nederlands',
    'french' => 'Frans',
