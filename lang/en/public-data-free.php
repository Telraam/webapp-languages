...
return [
    ...
    'section-1-text' => 'All Telraam devices come with the following data summaries as standard:<br>
                <br>
                <span class=" heroicon heroicon-check-circle" style="position:relative; top:4px "></span> Counts & direction of travel for 4 different grouped modes
                <ul class="jump-in" style="padding-left: 40px;">
                    <li>Pedestrians</li>
                    <li>Two-wheelers (bikes and motorbikes)</li>
                    <li>Cars</li>
                    <li>Heavy vehicles (vans, trucks, buses and more)</li>
                </ul>
                <br>
...
>>>>>>> 9563846e423c8c0ea91f9ae064347580deb82cc6
