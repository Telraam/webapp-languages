...
return [
    ...
    'title' => 'Data',
    'sub-title' => 'Professional applications require advanced data products. Dig deeper with a Telraam Premium subscription,
    ...
    'section-2-intro-text' => 'Benefit from the experience of the team behind Telraam. Get access to a
     range of advanced, purpose-made tools to explore and understand your data, facilitating and accelerating
      your research.<br>
      <br>
      The Premium subscription includes access to the Data dashboard, the Advanced <a href="https://telraam-api.net/">API</a>s, the Street sheets,
