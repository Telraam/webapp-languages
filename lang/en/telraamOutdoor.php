...
return [
    ...
    'section1-block1-text'        => '<p>Did you want to install a Telraam device to count traffic in your street, but the view
is blocked by this damn tree? Obviously, you don\'t want to cut the tree, but you do want to count traffic, so for you,
...
develop an autonomous Telraam S2 device which you can install outdoors. We want to keep the simplicity of installation, so
 ...
 and combine with a small solar panel and internal battery. Because our device consumes very little power, we expect to get
 by with a small solar panel & battery.</p>',
    ...
    'timeline-step2-subtitle'     => 'In cooporation with EiT and Provincie Vlaams Brabant',
    'timeline-step3-title'        => 'From prototype to market ready',

    // FAQ
    'faq-title'         => 'FAQ',
    'question-1'           => 'Any difference between the regular S2 and this outdoor device?',
	'answer-1'           => 'Not really. The device will work in the same way as the normal S2 for indoor use. It uses the same software
	to detect traffic, so the same requirements in terms location apply',

    'question-2'           => 'What will be the cost?',
 	'answer-2' 			=> 'We don\'t know yet. Obvisouly adding a solar panel, battery, enclosure and mounting mechanism
 	and more complex assembly will add to the cost. Expect an additional cost of several 100€s',
