...
The Telraam v1 device is still supported, but we won’t be making any improvements to the software. However, the Telraam v1 sensor is a Raspberry Pi based system (3A+) and you can definitely repurpose it for other uses.',
 	...
 	'answer-5' 			=> 'We did extensive testing and validation before launching the Telraam S2 sensor. From our tests on various locations, we expect accuracy for cars/buses/trucks to be 90-95% and for pedestrians/bikes around 80-85%. The performance also depends on the location of your Telraam (see <a href="https://telraam.helpspace-docs.io/article/43/potential-inaccuracies-with-telraam-s2"  target="_blank">FAQ</a>). You find detailed results of tests in the field in this <a href="https://github.com/Telraam/Telraam-S2/blob/main/count-consistency-validation.md"  target="_blank">article</a>.',
