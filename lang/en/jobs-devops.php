...
<li>Maintenance of the backend of Telraam in AWS (multiple production and testing databases, API Gateways, backups,
scheduled and conditional services, security, load management, etc.)</li>
<li>Manage, prepare, and schedule software updates of the backend (Postgres, python versions, layers, and libraries, etc…)</li>
<li>Development and deployment of proprietary edge-device firmware updates (C++)</li>
<li>Proactively search, develop, and implement incremental improvements to the AWS backend as well as the device firmware</li>
</ul>',
...
<li>Opportunity to premium training courses (e.g. cloud infrastructure operations by AWS)</li>
