...
return [
    ...
    'title' => 'Data Pool' ,
    'sub-title' => 'You don\'t want to roll out devices but still interested in the data?<br><br>
Welcome to Telraam\'s Data Pool - the ultimate destination for unlocking the power of community-sourced
    ...
    'section-1-what-text'     => 'Telraam\'s Data Pool is a user-friendly module within the Network subscription that lets you access data from devices outside your fleet. By using this pool, urban planners, researchers, and governments can get unprecedented insights to shape the future of our cities.',
    ...
    'section-1-key-title-3'  => 'No maintenance or commitments',
    ...
    'section-1-benefit-text'     => 'Telraam\'s Data Pool is designed to serve a wide range of clients, including:
                <ul class="jump-in">
                    ...
                    <li><strong>Researchers:</strong> Conduct in-depth studies on mobility trends, environmental
    ...
    // section 2
    'section-2-title' => 'The external advisory council',
...
<li>Evaluate if you\'re interested in one-shot historical data or a subscription to get the live data</li>
<li>Confirm the segments</li>
<li>Make sure you have enough credits.</li>
    ...
    'section-4-text'  => 'Currently the data pool is in beta only.<br>
