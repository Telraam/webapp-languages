...
return [
    ...
    'description' => 'Congratulations on being an S2 host. In the next steps we explain how to instal the device',
   ...
   'support' => 'support',
    ...
    'device-is-not-free-extra-info' => 'If it\'s your device please login.
    This action will notify the owner and network manager.',
