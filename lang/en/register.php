...
return [
    ...
    'title' => 'Register for a Telraam Account',
     'intro'        => 'Create a Telraam account so you can access all Telraam tools and services. You will need an account whether you are taking part in the Telraam Talks forum, setting up your Telraam device, joining a Network, or accessing the API.',
      'note'        => 'If you are planning on setting up a Telraam device, please review the <a href="https://telraam.zendesk.com/hc/en-us/articles/360019257837-Requirements-for-the-installation-of-Telraam-on-my-window-Registration-picture" target="_blank">ideal placement requirements here</a>',
