...
return [
    ...
    <a href="https://telraam.helpspace-docs.io/article/15/data-performance-and-validation">Data performance and validation (of Telraam S2)</a> for further updates on this topic.</p>',
    ...
    'section-features-block7-body' => '<p>The firmware of Telraam S2 is constantly evolving to provide the best possible experience for users. Updates are done remotely over the air (OTA) to ensure the device is always running the latest version.
Currently, our focus is on improving both connectivity and stability.</p>',
