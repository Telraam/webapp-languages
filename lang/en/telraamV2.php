...
return [
    ...
    'section-features-block1-body'     => '<p>The Telraam S2 device counts, categorises and reports all activity on your street: cars, bikes, pedestrians, buses, trucks and more. Get an accurate picture of who uses the street, when and how and start to have meaningful conversations about local traffic and mobility plans.',

    'section-features-block2-title'  => 'Purpose-built',
    'section-features-block2-subtitle'     => 'A brand new device for complete autonomy',
    'section-features-block2-body'     => '<p>Telraam S2 has been built from scratch for the specific purpose of counting traffic. A robust and reliable tool that will keep counting as long as you need it to.</p>
        <p><ul>
        <li>Custom-built PCB</li>
        <li>Integrated AI chip</li>
    ...
    'section-features-block4-body' => '<p>A design that fits effortlessly and quietly into your life, and your window view.</p>
        <p>The device is powered via a USB-C port, has a single button for user interaction, and comes with a colour LCD display. The screen can be turned off completely, which saves more energy, and so will not bother you whether in a living room or bedroom window.</p>
    ...
    'spec-table-row-1-subject'     => 'Chip',
    'spec-table-row-1-details' => 'Kendryte K210 Processor',
    ...
    'spec-table-row-3-details' => 'Lorem ipsum dolor',

    'spec-table-row-4-subject'     => 'Size',
    'spec-table-row-4-details' => '76 x 50 x 25',

    'spec-table-row-5-subject'     => 'Power',
    'spec-table-row-5-details' => '< 300mW<br>',

    'spec-table-row-6-subject'     => 'Privacy',
    'spec-table-row-6-details' => 'Counting AI on the device. <br>No videos are sent to the Telraam <br>',

    'spec-table-row-7-subject'     => 'Security',
    'spec-table-row-7-details' => 'Read - only memory（OTP)',
