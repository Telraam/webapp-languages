...
return [
    ...
    'subtitle'   => 'How to make sure your Telraam counts fine?<br> What are some of the most common pitfalls, how to prevent it and what to expect.',

    'location-title' => 'What is a suitable window or location?',

    'location-req-1-title' => 'Elevation & Floor Level',
    'location-txt-1-txt' => 'The device must be installed at least on the first floor (+1) or above 3-4m in height — ground floor locations are generally speaking not preferred.',
    ...
    'location-req-2-txt' => 'Must be far enough to fully capture large vehicles (e.g., vans), especially on narrow streets.
                If it\'s further away then 15m from the middle of the street the performance for pedestrians and cyclists weakens.',
    ...
    'how-txt' => 'Telraam uses AI to track and detect movement. Objects are recognized and a probability score is given to each object.
                Every object needs a certain probability score to be taken into account.
                If that object enters then on one side and leaves on the other side we have a count registered.
                <br>
                ...
                <ul class="jump-in">
                    ...
                    <li>Pedestrians or bikes, especially when there are individually obscured by walking / cycling in groups or far away from the camera may be wrongly classified or not fully counted.</li>
                </ul>',
    ...
    'location-more-txt' => 'If you\'re unsure, you can consult a <a href="https://faq.telraam.net/article/3/requirements-for-a-suitable-window-and-location">dedicated FAQ article for more details</a> or
                <a href="here https://faq.telraam.net/article/357/location-guidelines-for-telraam-s2-outdoor">separate, comprehensive article about S2 Outdoor requirements</a>.',
    ...
    'tubes-txt' => ' We won\'t lie, these days pneumatic tubes are the standard for traffic counting.
However independent real world tests showed <a href="https://nap.nationalacademies.org/read/22223/chapter/6#77" target="_blank">10-20% error margin</a><sup>1 2</sup>,
                mostly undercounts. We typically achieve at least the same same accuracy performance with less hassle. Tube installations are labor intensive, need maintance and have a short life span.
Telraam is easy to install and counts all modes out of the box, with an additional benefit it will count for a longer period.!br>
    ...
    // more/advanced part
    'more-title'    => 'More on accuracy, speed data,...',

    'more-1-title'  => 'Edge cases',
    'more-1-txt'    => ' If you\'d like to deepen your understanding further what can cause inaccuracies with the Telraam and how to avoid them, you can learn more in the
...
<a href="https://faq.telraam.net/article/41/speed-measurements-with-telraam-s2">faq article about speed measurements</a>',
    ...
    'more-3-txt' => 'An overview of our own validation counts and experiments to evaluate the count performance of the K210 firmware:
                <a href="https://github.com/Telraam/Telraam-S2/blob/main/count-performance-validation.md">count performance tests of our current and previous K210 firmware</a>.',
