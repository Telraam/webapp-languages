...
return [
    ...
    'title' => 'Données',
    'sub-title' => 'Les applications professionnelles nécessitent des produits de données avancés. Approfondissez avec l\'abonnement Telraam Data,
    et libérez tout le potentiel du dispositif Telraam S2 : accédez aux comptages au niveau du segment et du dispositif avec une résolution temporelle plus fine,
    davantage de modes de trafic, des API avancées et un large éventail d\'outils de visualisation et d\'analyse.',
    ...
    'pricing-1-info' => 'Plusieurs dispositifs dans votre quartier en tant qu\'organisation ou ville ?
                            <div style="padding-left: 20px">
                                ...
                                Celui-ci inclut un abonnement aux données pour tous les dispositifs, ainsi qu\'un ensemble riche d\'outils de gestion de réseau.
                            </div>',
    ...
    'section-1-intro' => 'Les abonnés aux données ont accès à des données de comptage avec une résolution temporelle quatre fois supérieure à celle de notre jeu de données de base, et à un ensemble étendu de catégories d\'usagers de la route
    ...
    de visualisation et d\'exportation, ainsi que pour les API.
    <ul class="jump-in">
        <li>Découvrez, suivez et analysez les schémas de circulation et les anomalies avec plus de clarté.</li>
        <li>Idéal pour l\'étude des événements de courte durée (utilisation de la rue par les écoliers, congestions, accidents).</li>
    ...
    <p><strong>10 modes différents</strong><br>
     <br>
     Comptage de la circulation par sens de déplacement pour 10 catégories différentes d\'usagers de la route (les utilisateurs non abonnés
     reçoivent des comptages agrégés sur les quatre principales catégories).<br>
     Les catégories différenciées sont les vélos, les bus, les voitures, les camionnettes légères, les motos, les piétons, les poussettes, les tracteurs,
     les remorques et les camions.</p>
     <br>
    ',
    ...
    À titre d\'exemple, les données typiques comprennent les comptages typiques (moyens) (et la plage la plus probable) pour la circulation automobile attendue pour un lundi matin
    entre 08:00 et 08:15, sur la base des 12 derniers mois de trafic réel - mais vous pouvez choisir un mode, un jour de la semaine, une heure de la journée et une période de référence différente comme vous le souhaitez. Comment cela fonctionne-t-il en pratique ?
    <ul class="jump-in">
    ...
    'section-2-title' => 'Plus d\'outils, de meilleures insights et un contrôle complet',
    ...
    'section-2-intro-text' => 'Bénéficiez de l\'expérience de l\'équipe derrière Telraam. Accédez à une
     gamme d\'outils avancés spécialement conçus pour explorer et comprendre vos données, facilitant et accélérant
      votre recherche.<br>
      <br>
      L\'abonnement aux données comprend l\'accès au tableau de bord Data, aux API avancées, aux fiches de rue,
    ...
    'features-1-text' => 'Surveillez le trafic en direct ou historique (et la répartition modale globale) sur un segment et comparez-le aux niveaux attendus pour identifier un trafic atypique.<br> Par exemple : si le trafic en direct est en dehors de
    de l\'intervalle défini par la moyenne plus et moins trois fois l\'écart type du trafic historique, cela signifie que le trafic observé
    est inattendu par rapport à la moyenne du mois dernier, de la saison ou de l\'année, en fonction du produit de données typiques utilisé. L\'anomalie est-elle de courte durée ou à long terme,
    est-elle causée par un événement spécial, par les conditions météorologiques ou par un changement dans le plan de circulation ? Allez et explorez !',
    ...
    // 3 extra features
    'extra-features-1-title' => 'Fiche de rue',
...
les répartitions modales, les motifs de trafic typiques (pour les jours et les semaines), et aussi les motifs de vitesse.',
    ...
    'extra-features-2-text' => 'Accédez à des points de terminaison API exclusifs et professionnels :
    <ul class="jump-in">
        ...
        <li>Possibilité d\'intégrations et de points de terminaison personnalisés par accord ou collaboration avec l\'équipe Telraam.</li>
    </ul>',

    'extra-features-3-title' => 'Exportation de données brutes',
    'extra-features-3-text' => 'Téléchargez des données de comptage brutes (sous forme de feuilles de calcul ou de fichiers CSV) pour effectuer des analyses plus personnalisées.
    <ul class="jump-in">
        <li>L\'outil d\'exportation de données permet aux organisations qui n\'ont pas de grands lacs de données ou de systèmes BI d\'exporter,
        de réutiliser et de personnaliser des rapports à partir d\'un ou même de plusieurs dispositifs.</li>
<li>Les exportations de données comprennent des graphiques, des calculs, des valeurs typiques et des données brutes provenant du dispositif.
<li>Adaptez les rapports pour inclure des éléments particulièrement pertinents pour votre rue : motifs de changement modal, variations de vitesse avant ou après les interventions, volumes de trafic au fil du temps, et plus encore.
</li>
</ul>',
