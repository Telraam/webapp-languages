...
return [
    ...
    'policy-list-1-content' => '<li>Telraam est exploité par Rear Window BV, dont le siège social est situé Vital Decosterstraat 67A bus 1010, Louvain 3010, Belgique, sous le numéro d\'entreprise 0762.549.266 (ci-après "<strong>Telraam</strong>", "<strong>nous</strong>" ou "<strong>notre</strong>").</li>
...
<li>En cas de résiliation, vous devez renvoyer et/ou restituer le dispositif Telraam conformément aux instructions de Telraam.</li>',
    ...
    'policy-list-4-content' => '<li>Les comptages de trafic ne contiennent aucune donnée personnelle. En tant que participant, vous fournirez certaines données personnelles (notamment votre nom, votre adresse et votre adresse électronique) à Telraam. Nous traiterons ces données personnelles conformément à notre politique de confidentialité (à consulter via : https://telraam.net/fr/privacy-policy).</li>
<li>Si vous avez des questions concernant le traitement de vos données personnelles et/ou pour exercer vos droits, veuillez nous contacter via privacy@telraam.net.</li>',
...
une licence à cet effet de notre part et/ou de nos concédants.</li>',
    ...
    'policy-list-6-title' => 'Responsabilité civile',
    'policy-list-6-content' => '<li>Dans la mesure où la loi le permet, Telraam ne sera pas responsable de toute perte ou de tout dommage, même prévisible, résultant de votre participation à Telraam ou en rapport avec celle-ci.</li>
<li>En particulier, nous ne serons pas responsables de toute perte ou de tout dommage résultant de l\'installation et/ou de l\'utilisation du dispositif Telraam non effectuée conformément aux instructions de Telraam.</li>
<li>Telraam ne sera pas non plus responsable de tout dommage indirect, y compris (mais sans s\'y limiter) la perte de bénéfices, d\'économies prévues ou d\'opportunités ou de bonne volonté.</li>
<li>Dans tous les cas et notamment si l\'exclusion de responsabilité ci-dessus est annulée en tout ou partie par un tribunal compétent, nous ne serons responsables que des dommages directs démontrables et la responsabilité de Telraam pour ces dommages directs ne dépassera jamais cent cinquante euros (150 €) au total.</li>
<li>L\'appareil Telraam V1 n\'est pas fabriqué par Telraam et Telraam ne peut être tenu responsable de tout dommage causé par l\'appareil Telraam. Dans tous les cas, seules les conditions (de garantie) du fabricant concerné (telles que les conditions de Gotron BV, https://www.gotron.be/verkoopsvoorwaarden) sont applicables (dans la mesure où la loi le permet).</li>
<li>Bien que nous fassions des efforts raisonnables pour mettre à jour les informations sur notre site web, nous ne faisons aucune déclaration, garantie ou assurance, expresse ou implicite, que le
