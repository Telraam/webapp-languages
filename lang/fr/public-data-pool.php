...
publics peuvent obtenir des informations inédites pour façonner l\'avenir de nos villes.',
    ...
    'section-1-key-text-1'   => 'Restez informé grâce à des flux de données continuellement actualisées, fournissant les dernières informations sur la dynamique de la mobilité urbaine.',
    'section-1-key-title-2'  => 'API avancée',
    'section-1-key-text-2'   => 'Avec Data Pool, vous bénéficiez d\'analyses avancées via API, comprenant des limites de données personnalisées, une résolution de 15 minutes, 10 modes différents, des données typiques, et bien plus encore.',
    'section-1-key-title-3'  => 'Aucune maintenance ou entretien requis',
    'section-1-key-text-3'   => 'Obtenez des informations détaillées sans les responsabilités de propriété, d\'installation ou de maintenance.',

    'section-1-benefit-title' => 'Qui peut en bénéficier ?',
    'section-1-benefit-text'     => 'Le Data Pool de Telraam est conçu pour répondre aux besoins d\'une vaste gamme de clients, notamment:
                <ul class="jump-in">
                    <li><strong>Urbanistes :</strong> Élaborer des plans stratégiques de transport, optimiser les stratégies de gestion du trafic et renforcer le développement des infrastructures.</li>
                    <li><strong>Chercheurs et Activistes :</strong> mener des études approfondies sur les tendances en matière de mobilité, les incidences sur l\'environnement et la dynamique sociale dans les environnements urbains.</li>
                    <li><strong>Gouvernements municipaux :</strong> soutenir l\'élaboration de politiques fondées sur des données probantes, améliorer les systèmes de transport public et relever efficacement les défis urbains.</li>
                </ul>',

    // section 2
    'section-2-title' => 'Notre conseil consultatif externe',
...
Nous organisons environ 5 séances numériques par an pour recueillir des contributions, qui seront publiées ouvertement sur notre site web. Si vous souhaitez participer,
 <a href="/fr/contact-us">contactez-nous</a>.',
    ...
    'section-3-text'  => '<ol>
<li>Dans le tableau de bord de votre réseau, parcourez la carte et ajoutez des segments au "panier".</li>
<li>Décidez si vous êtes intéressé par des données historiques ponctuelles ou par un abonnement vous permettant d\'obtenir des données en temps réel.</li>
<li>Confirmez vos choix de segments</li>
<li>Assurez-vous que vous disposez de suffisamment de crédits.</li>
</ol>',
