...
return [
    'subject'        => 'Votre appareil S2 fonctionne mieux si vous définissez une région d\'intérêt',
     'addressing' => 'Bonjour',
        'body' => "Vous avez installé avec succès un appareil Telraam S2. Merci!<br><br>
          Cependant, pour nous assurer que l'appareil compte avec précision, nous aimerions vous demander de sélectionner la meilleure région d'intérêt (ROI) pour votre appareil photo.<br><br>
                Le S2 dispose d'une caméra grand angle intégrée et la reconnaissance d'image fonctionne mieux si vous pouvez réduire la vue de la caméra. Nous ne voulons pas que l'appareil compte les oiseaux ou les poubelles volantes, mais utilise toutes ses ressources pour suivre l'activité dans votre rue.<br>
      <br>
