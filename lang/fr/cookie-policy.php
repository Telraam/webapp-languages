...
return [
    ...
    'content-1' => 'Cette politique en matière de cookies s\'applique au site web www.telraam.net (le <strong>"site web"</strong>), proposé,
     détenu et fourni par Rear Window BV, dont le siège social est situé à Vital Decosterstraat 67/A,
    ...
    'content-2' => 'Les cookies sont de petits éléments d\'information sous forme de fichiers texte qui sont placés sur le disque
    dur de votre ordinateur lorsque vous visitez le site web. ',

    'title-3' => '3. Quels sont les cookies utilisés par le site web ?',
    'content-3' => "Le site web utilise les cookies suivants:<br><br>
...
",
    ...
    'title-4' => '4. Combien de temps les cookies restent-ils valides ?',
    'content-4' => "<i>Les cookies de session</i> ne sont conservés que pendant la session en cours de votre navigateur.
...
Vous pouvez trouver la date d'expiration exacte des cookies utilisés dans le tableau ci-dessus",
    ...
    'title-5' => '5.	Cookies de "first" et "third party"',
    'content-5' => '<i>Les "First party" cookie</i> sont des cookies que Telraam place sur votre appareil. <br>
...
Ces cookies tiers sont par exemple liés à Google Analytics.',
    ...
    'title-6' => '6.	Gestion des cookies',
    'content-6' => "Vous pouvez gérer vous-même l'utilisation des cookies.
