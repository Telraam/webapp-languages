...
<li>Vous disposez d’une prise de courant à proximité de la fenêtre (si nécessaire grâce à une rallonge)</li>',
    ...
    'nav-main-title'     => 'Installation de la caméra',
    'nav-title-1'     => 'Adresse',
    ...
    'select-language' => 'Votre langue préférée',
    'english' => 'Anglais',
    'dutch' => 'Néerlandais',
    'french' => 'Français',
    ...
    'network-own' => "Je n'ai pas de Telraam / Je m'installe de façon indépendante.",
    'network-professionals' => "J'installe une Telraam dans le cadre d'un réseau existant."
];
